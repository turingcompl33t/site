+++
title = 'A Statistical Character Bigram Language Model'
date = 2025-12-02
slug = 'makemore-bigram'
description = 'Building a statistical character-level bigram language model - the first step from raw autograd toward models that emulate natural language.'
