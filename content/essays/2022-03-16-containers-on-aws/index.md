...
description = 'Comparing several options for deploying containerized applications on AWS across usability, scalability, and pricing.'
tags = ['cloud']
+++
...
![Lightsail Pricing](lightsail-pricing.webp)
...
![Lambda Create](lambda-create.webp)
...
![Lambda Create](lambda-setup.webp)
